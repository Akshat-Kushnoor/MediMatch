...
async function runDemo() {
    const client = new socketClient_1.SocketClient('localhost', 3000);
    ...
    try {
        ...
        console.log(`✗ Error registering donor: ${error.message}`);
    }
    console.log('');
    ...
    try {
        ...
        console.log(`✗ Error finding hospital: ${error.message}`);
    }
    console.log('');
    ...
    try {
        ...
        console.log(`✗ Error matching request: ${error.message}`);
    }
    console.log('\n=== Demo Complete ===');
}
